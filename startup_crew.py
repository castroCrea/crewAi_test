...
task1 = Task(
    ...
    """,
    agent=marketer,
    expected_output="Detailed report analyzing market demand, ideal customer profile, and marketing strategies for plugs for crocs."
)
...
task2 = Task(
    ...
    """,
    agent=technologist,
    expected_output="Detailed report on technologies required for producing plugs for crocs."
)
...
task3 = Task(
    ...
    expected_output="Detailed business plan outlining strategies for a sustainable and profitable business based on the marketing and technological reports."
)
